#cs ----------------------------------------------------------------------------
 ...
 Version Information:
   ...
   2、2014-12-23 Ver2.0		根据输入的品种、开仓方向、开仓价格、开仓手数进行下单
 How To Userd:
   1、函数做为自动下单系统的一部分，在预警发生后自动填写下单的各种数据，
   2、函数未经用户确认，而直接下单，使用时需要谨慎。
#ce ----------------------------------------------------------------------------
...
;开仓
$hdopen = ControlGetHandle ("招商银行招财金黄金交易客户端","开   平","[CLASS:WindowsForms10.BUTTON.app.0.1e84ccb; INSTANCE:8]")
...
ControlClick("招商银行招财金黄金交易客户端","下单","[CLASS:WindowsForms10.BUTTON.app.0.1e84ccb; INSTANCE:5]","left",40,16);
